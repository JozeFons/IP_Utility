@echo off
  ...
  mode con:cols=140 lines=50 buffer=9999
  ...
  if "%wrong_input%" == "true" goto :ADAPTER_SELECTION 
  ...
  echo.
  echo    11 Show ALL listening ports / Zobraz vsetky nasluchajuce porty
  echo.
  echo    12 Show ALL listening and non-listening ports / Zobraz vsetky pritomne porty 
  echo.
  echo    13 Show multiple connections on active applications / Zobraz vetvenie pripojeni na aktivnych aplikaciach
  echo.
  echo    14 Interface list and Routing table for IPv4 and IPv6 / Zoznam rozhrani a smerovacia tabulka pre IPv4 a IPv6
  echo.
  echo    15 Exit / Koniec
  echo "======================================================================================================="
  echo.
  ...
  (
    ...
    echo 196.245.151.217 Exhausts on H8
